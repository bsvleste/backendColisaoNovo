...
import { BidRepository } from "../../application/repositories/in-memory-repository/bid-repository";
import { createBidController } from "../../application/use-cases/create-bid";
